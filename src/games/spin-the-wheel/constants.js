...
// Every NFL player — K and DEF included — can be drafted by only one player
// per game (in shared mode, only one per round-team). Drafting someone
// already taken is a last-resort fallback, unlocked only when the picker has
// no fresh option at any open slot — typically the team's lone DEF or K, but
// in historical mode a thin QB/TE room can trigger it too (see takenIds and
// dupAllowed in Game.jsx).
